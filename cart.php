        ...
        <?php foreach ($cart as $product_id => $product) { ?>
            <div class="single-cart clearfix">
                ...
                <div class="cart-info">
                    ...
                    <a href="cart.php?remove=true&product_id=<?php echo $product_id; ?>" class="cart-delete" title="Remove this item"><i class="fa fa-trash-o"></i></a>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="table-responsive mb-30">
                    <table class="table cart-table text-center">
                        ...
                        <tbody>
                            ...
                            $subtotal = 0; // Khởi tạo biến subtotal để tính tổng số tiền
                            foreach ($cart as $product_id => $product) {
                                $subtotal += $product['price'] * $product['quantity']; // Cộng dồn giá tiền của từng sản phẩm
                            ?>
                           

                                <tr>
                                    <td><span class="cart-number">1</span></td>
                                    <td><a href="#" class="cart-pro-image"><img src="<?php echo $product['image']; ?>" alt=""></a></td>
                                    ...
                                    <td>
                                        <a href="cart.php?remove=true&product_id=<?php echo $product_id; ?>" class="cart-pro-remove">
                ...
                if (!empty($cart)) {
                    ...
                    echo '<p><span>Subtotal</span><span>$' . number_format($subtotal, 2) . '</span></p>';
                    echo '<h5><span>Grand total</span><span>$' . number_format($subtotal, 2) . '</span></h5>';
                } else {
                    echo "Giỏ hàng trống";
                }
                ?>
                ...
                <div class="row">
                    ...
                    <!-- Cart Coupon -->
                    <div class="cart-coupon col-lg-4 col-md-6 col-12 mb-30">
                    ...
                    <div class="cart-checkout-process col-lg-4 col-md-6 col-12 mb-30">
                        ...
                        <h5><span>Grand total</span><span>$<?php echo number_format($subtotal, 2); ?></span></h5>
                        <button class="button"><a href="checkout.php">Process to Checkout</button>
                    </div>
...
<?php
    ...
    echo '<div class="cart-section section pt-120 pb-90">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        Giỏ hàng trống
