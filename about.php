        ...
        <?php foreach ($cart as $product_id => $product) { ?>
            <div class="single-cart clearfix">
                ...
                <div class="cart-info">
                    ...
                    <a href="about.php?remove=true&product_id=<?php echo $product_id; ?>" class="cart-delete" title="Remove this item"><i class="fa fa-trash-o"></i></a>
        ...
        <div class="container">
            <div class="row flex-row-reverse">
                ...
                <div class="about-content col-lg-6 col-12 mb-30">
                    <h2> <span>Warm embrace in a cup</span></h2>
                    <p><span><b>Coffee</b></span>, the beloved beverage enjoyed by milions worldwide, is known for its bold
                        flavor, rich aroma, and ability to provide a comforting warmth in every sip. It's often considerd an
                        essential morning pick-me-up, but can be enjoyed at any time of day. Whether sipping alone or with
                        company, coffee provides the perfect accompaniment to conversation and socializing.</p>
            ...
            <div class="row flex-row-reverse">
                <div class="about-image col-lg-6 col-12 mb-30">
                    <img src="img/cafe.webp" alt=""></a>
                 </div>
                <div class="about-content col-lg-6 col-12 mb-30">
                    <h2><span>START THE NEW YEAR FULL OF SWEET CARAMEL MACCHIATO</span></h2>
                    <p>The three main ingredients that make up <span><b>The Coffee House's Caramel Macchiato </b></span>are:
                        Espresso coffee, hot fresh milk and Caramel sauce. A glass of Caramel Macchiato is cleverly prepared
                        with hot fresh milk and a rich Espresso base that "touches" but doesn't blend, creating beautifully
                        interwoven brown and white streaks.
    
                        Then, the baristas of The Coffee House added the sweet flavor of caramel sauce - making this drink
                        not only fun to the eyes but also really "addictive".
    
                        At The Coffee House, we liken Caramel Macchiato as an enjoyable sip, because each sip brings a sweet
                        surprise - the combination of the rich aroma of fresh milk, the elegant bitter taste of the Espresso
                        background. , and the rich sweetness of Caramel sauce.
    
                        <i>To start a new year full of surprises and sweets, you must definitely stop by the House and enjoy a
                        glass of Caramel Macchiato!</i></p>
                </div>
